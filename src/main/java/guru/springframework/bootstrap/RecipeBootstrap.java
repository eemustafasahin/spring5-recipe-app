...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed." +
                ...
                " The guacamole should be a little chunky.)" +  "3 Add salt, lime juice, and the rest:" +
                " Sprinkle with salt and lime (or lemon) juice. The acid in the lime juice will provide" +
                ...
                " Start with this recipe and adjust to your taste. 4 Cover with plastic and chill to store:" +
                ...
                " Refrigerate until ready to serve. Chilling tomatoes hurts their flavor," +
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
                ...
                " and chunks of peaches in it (a Diana Kennedy favorite). Try guacamole with added pineapple," +
                " mango, or strawberries. The simplest version of guacamole is just mashed avocados with salt." +
        ...
        //guacNotes.setRecipe(guacRecipe); no need anymore. we added helper method
...
//        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom, guacRecipe));
        ...
        //with helper methods the above method become like these
        ...
        //tacoNotes.setRecipe(tacosRecipe); no need anymore. we added alper method.
